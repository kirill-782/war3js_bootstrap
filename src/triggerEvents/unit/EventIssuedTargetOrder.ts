...
import { GetIssuedOrderId, GetOrderTarget, GetOrderTargetDestructable, GetOrderTargetItem, GetOrderTargetUnit } from "../../utils/common.js";
import { TriggerUnitEvent } from "./Event.js";

export class TriggerUnitEventIssuedTargetOrder extends TriggerUnitEvent<"issuedTargetOrder"> {
